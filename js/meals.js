...
const DINNERS = [
  ...
  {
    id:'d16', type:'dinner', emoji:'🌶',
    name:'Chicken Vindaloo',
    tags:['spicy','indian'],
    prepTime:30, cal:440, protein:36,
    ingredients:[
      { name:'chicken thighs', qty:5,    unit:'oz',    category:'protein' },
      { name:'potato',         qty:1,    unit:'',      category:'produce' },
      { name:'onion',          qty:0.5,  unit:'',      category:'produce' },
      { name:'garlic cloves',  qty:3,    unit:'',      category:'produce' },
      { name:'fresh ginger',   qty:0.25, unit:'oz',    category:'produce' },
      { name:'red wine vinegar',qty:1,   unit:'tbsp',  category:'pantry'  },
      { name:'canned diced tomatoes',qty:3,unit:'oz',  category:'canned'  },
    ...
    steps:[
      'Cook rice. Peel and cube potato; parboil 5 min until just tender.',
      'Marinate chicken in vinegar, chili powder and cumin 10 min if time allows.',
      'Sear chicken in oil 4-5 min until browned. Remove.',
      'Cook diced onion 5 min. Add garlic, ginger and paprika, cook 1 min.',
      'Add tomatoes, chicken and potato. Simmer 15 min until sauce thickens and potato is tender.',
      'Serve over rice.',
    ],
  },
  {
    id:'d17', type:'dinner', emoji:'🍛',
    name:'Lamb Rogan Josh',
    tags:['spicy','indian','red-meat'],
    prepTime:35, cal:480, protein:34,
    ingredients:[
      { name:'lamb shoulder',  qty:5,    unit:'oz',    category:'protein' },
      { name:'canned diced tomatoes',qty:5,unit:'oz',  category:'canned'  },
      { name:'Greek yogurt',   qty:2,    unit:'oz',    category:'dairy'   },
      { name:'onion',          qty:0.5,  unit:'',      category:'produce' },
      { name:'garlic cloves',  qty:2,    unit:'',      category:'produce' },
      { name:'fresh ginger',   qty:0.25, unit:'oz',    category:'produce' },
      { name:'basmati rice',   qty:0.33, unit:'cups',  category:'grains'  },
    ...
    steps:[
      'Cook rice. Brown lamb pieces in oil, 5-6 min. Remove.',
      'Cook diced onion 5 min. Add garlic, ginger and spices, cook 1 min.',
      'Add tomatoes, return lamb, cover and simmer 20 min until tender.',
      'Stir in yogurt off the heat. Serve over rice.',
    ],
  },
  {
    id:'d18', type:'dinner', emoji:'🔥',
    name:'Chicken Madras',
    tags:['spicy','indian'],
    prepTime:25, cal:420, protein:38,
    ingredients:[
      { name:'chicken thighs', qty:5,    unit:'oz',    category:'protein' },
      { name:'canned diced tomatoes',qty:5,unit:'oz',  category:'canned'  },
      { name:'onion',          qty:0.5,  unit:'',      category:'produce' },
      { name:'garlic cloves',  qty:2,    unit:'',      category:'produce' },
      { name:'fresh ginger',   qty:0.25, unit:'oz',    category:'produce' },
      { name:'tomato paste',   qty:1,    unit:'tbsp',  category:'pantry'  },
      { name:'basmati rice',   qty:0.33, unit:'cups',  category:'grains'  },
      { name:'chili powder',   qty:1.5,  unit:'tsp',   category:'spices'  },
      { name:'garam masala',   qty:0.5,  unit:'tsp',   category:'spices'  },
      { name:'cumin',          qty:0.5,  unit:'tsp',   category:'spices'  },
    ],
    steps:[
      'Cook rice. Cook diced onion in oil 5 min.',
      'Add garlic, ginger and spices, cook 1-2 min. Stir in tomato paste.',
      'Add tomatoes and chicken. Cover and simmer 15 min until chicken is cooked through and sauce is deep red.',
      'Serve over rice.',
    ],
  },
  {
    id:'d19', type:'dinner', emoji:'🥥',
    name:'Chicken Korma',
    tags:['indian','simple'],
    prepTime:25, cal:520, protein:34,
    ingredients:[
      { name:'chicken thighs', qty:5,    unit:'oz',    category:'protein' },
      { name:'coconut milk',   qty:4,    unit:'fl oz', category:'canned'  },
      { name:'Greek yogurt',   qty:2,    unit:'oz',    category:'dairy'   },
      { name:'onion',          qty:0.5,  unit:'',      category:'produce' },
      { name:'garlic cloves',  qty:2,    unit:'',      category:'produce' },
      { name:'fresh ginger',   qty:0.25, unit:'oz',    category:'produce' },
      ...
      { name:'cumin',          qty:0.25, unit:'tsp',   category:'spices'  },
    ],
    steps:[
      'Cook rice. Cook diced onion in oil 5 min until soft.',
      'Add garlic, ginger and spices, cook 1 min.',
      'Add chicken and cook 3 min. Pour in coconut milk, simmer 12 min.',
      'Stir in yogurt off the heat. Serve over rice.',
    ],
  },
  {
    id:'d20', type:'dinner', emoji:'🫑',
    name:'Chicken Jalfrezi',
    tags:['spicy','indian','quick'],
    prepTime:20, cal:400, protein:36,
    ingredients:[
      { name:'chicken thighs', qty:5,    unit:'oz',    category:'protein' },
      { name:'bell pepper',    qty:1,    unit:'',      category:'produce' },
      { name:'onion',          qty:0.5,  unit:'',      category:'produce' },
      { name:'garlic cloves',  qty:2,    unit:'',      category:'produce' },
      { name:'canned diced tomatoes',qty:4,unit:'oz',  category:'canned'  },
      { name:'basmati rice',   qty:0.33, unit:'cups',  category:'grains'  },
      { name:'chili powder',   qty:1,    unit:'tsp',   category:'spices'  },
      { name:'cumin',          qty:0.5,  unit:'tsp',   category:'spices'  },
      { name:'garam masala',   qty:0.5,  unit:'tsp',   category:'spices'  },
    ...
    steps:[
      'Cook rice. Slice chicken, pepper and onion into strips.',
      'Stir-fry chicken in oil on high heat 4-5 min. Remove.',
      'Stir-fry pepper and onion 3 min. Add garlic and spices, cook 1 min.',
      'Return chicken, add tomatoes, simmer 6-8 min until thick. Serve over rice.',
    ],
  },
  {
    id:'d21', type:'dinner', emoji:'🥬',
    name:'Saag Chicken',
    tags:['indian'],
    prepTime:25, cal:400, protein:38,
    ingredients:[
      { name:'chicken thighs', qty:5,    unit:'oz',    category:'protein' },
    ...
    steps:[
      'Cook rice. Wilt spinach in a pan, then finely chop or blend into a rough puree.',
      'Cook diced onion in oil 5 min. Add garlic, ginger and spices, cook 1 min.',
      'Add chicken, cook 6-7 min until browned and nearly cooked through.',
      'Stir in spinach puree, simmer 5 min. Off the heat, stir in yogurt. Serve over rice.',
    ],
  },
